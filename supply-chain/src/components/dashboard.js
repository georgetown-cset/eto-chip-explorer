...
const Dashboard = () => {
  ...
  return (<AppWrapper>
    ...
    <InfoCard title={"Supply Chain Explorer"} description={
      <div>
        ETO's Semiconductor Supply Chain Explorer is designed to quickly orient non-experts to the essential inputs, players, and relationships involved in producing advanced computer chips. Use the Explorer to learn how these chips are made, who makes them, and the tools, materials, and processes involved in the supply chain.
